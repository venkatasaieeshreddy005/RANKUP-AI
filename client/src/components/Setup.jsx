          ...
          <div className="space-y-6">
            ...
            {resumeFile && !analysisDone && (
              <motion.button
                ...
                className="w-full mt-4 bg-gray-900 text-white px-5 py-3 rounded-xl hover:bg-gray-800 transition font-medium"
              >
            ...
            {/* Start Button */}
            <button
              onClick={() => onStart({ role, experience, mode, resumeFile })}
              className="w-full py-4 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 transition shadow-lg mt-4"
            >
              Start Interview
            </button>
          </div>
